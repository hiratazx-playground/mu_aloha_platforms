...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    /* DDR Regions */
    { "Kernel"             ,0x80000000, 0x00E00000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "DBI Dump"           ,0x80E00000, 0x00CC0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN },
    ...
    { "HLOS2"              ,0x85F10000, 0x000D0000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN },
    ...
    { "HLOS3"              ,0x86200000, 0x00B00000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    ...
    { "PIL_REGION"         ,0x8BF00000, 0x0D600000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    { "DXE Heap"           ,0x99500000, 0x03F00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN },
    { "Display Reserved"   ,0x9D400000, 0x02400000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH },
    ...
    { "TPMControl"         ,0x9FFDA000, 0x00003000, AddMem, MEM_RES, UNCACHEABLE, RtData, UNCACHED_UNBUFFERED_XN },
    ...
    { "RAM Partition"      ,0xA0000000, 0x40000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
    { "RAM Partition"      ,0x100000000, 0x40000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
